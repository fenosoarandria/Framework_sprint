package etu1858.framework;
import javax.servlet.*;
import javax.servlet.http.*;
import java.util.*;
import java.sql.SQLException;
import java.io.*;
import etu1858.framework.annotation.*;
...
public class Utilitaire{
    ...
    {
        ArrayList<String> nomclasses = this.get_AllClass("/WEB-INF/classes/etu1858/framework/modele");
    ...
    public HashMap<String,Mapping>  getHashmap(HashMap<String,Mapping> mappingUrls,ServletContext context) throws Exception
    {
         ...
         String path = context.getRealPath( "/WEB-INF/classes/etu1858/framework/modele");
